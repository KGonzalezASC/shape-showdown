...
A tall 10×20 board has to fit everything from a 360px phone to a desktop showing **two** full boards side by side. This guide covers the two-layout split, the scale-to-fit math, and the gotchas that caused every "not responsive" bug report.

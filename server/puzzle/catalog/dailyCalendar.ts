...
export const DAILY_SCHEDULE: Record<string, string> = {
  // Seeded after authored catalog grows; see buildAuthoredLevels().
  ...
  '2026-09-05': 'authored-cheese-keyhole',
  '2026-09-06': 'authored-well-freeze',
  '2026-09-07': 'authored-skew-stairs',
};

...
export const MatchChrome: React.FC = () => {
  ...
  return (
    <div
      className={`ss-match-chrome flex min-h-7 shrink-0 items-center justify-center border-b border-[var(--ss-chrome-rule)] px-3 py-1 text-center text-[8px] font-bold uppercase tracking-[0.12em] ${
        isWaitingForPlayer
